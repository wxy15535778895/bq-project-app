	...
	<view>
		<form>
			...
			<view class="cu-form-group">
				...
				<input placeholder="请输入填写人" v-model="form.writtenPerson" name="input"></input>
			</view>
			...
			<view class="cu-form-group align-start">
				<view class="title">回执意见</view>
				<textarea maxlength="-1" v-model="form.opinionContent" placeholder="请输入监理工程师对回执内容意见"></textarea>
			</view>
