	...
	<view>
		<form>
			<view class="cu-form-group margin-top">
				...
				<input placeholder="请输入日志编号" disabled="true" v-model="form.bak2" name="input"></input>
			</view>
			<view class="cu-form-group">
				<view class="title">施工单位</view>
				<input placeholder="请输入单位名称" v-model="form.workUnit" name="input"></input>
			</view>
			<view class="cu-form-group">
			...
			<view class="cu-form-group align-start">
				<view class="title">生成情况记录</view>
				<textarea maxlength="-1" v-model="form.productionRecord"
					placeholder="请输入生成情况记录"></textarea>
			</view>
			<view class="cu-form-group align-start">
				<view class="title">技术质量安全记录</view>
				<textarea maxlength="-1" v-model="form.safeRecord"
					placeholder="请输入技术质量安全记录"></textarea>
			</view>
			<view class="cu-form-group align-start">
				<view class="title">备注</view>
				<textarea maxlength="-1" v-model="form.remark"
		...
		data() {
			return {
				form: {
					...
					stake: "",
					weather: "",
					workTime: new Date().toISOString().slice(0, 10),
					workUnit: "",
					writePerson: "",
					bak2: "",
					bak2: ''
