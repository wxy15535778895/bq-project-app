<template>
	<view class="body" style="height: 105%;">
		<view class="typebox">
			<p class="choice" @tap="change(0)" :class="{btna:btnnum == 0}">执法协作</p>
			<p class="choice" @tap="change(1)" :class="{btna:btnnum == 1}">案件办理</p>
			<p class="choice" @tap="change(2)" :class="{btna:btnnum == 2}">案件查询</p>
		</view>
...
<script>
	import Luji from '../query/index'
	import Lumian from '../case/index'
	import Yanxian from '../Journal/index'
