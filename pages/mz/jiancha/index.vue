<template>
	<view class="body" style="height: 105%;">
		<view class="typebox">
			<p class="choice" @tap="change(0)" :class="{btna:btnnum == 0}">公交车</p>
			<p class="choice" @tap="change(1)" :class="{btna:btnnum == 1}">出租车</p>
			<p class="choice" @tap="change(2)" :class="{btna:btnnum == 2}">运管局</p>
		</view>
