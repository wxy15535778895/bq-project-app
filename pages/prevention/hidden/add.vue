<template>
	<view class="body">
		<view class="content">
			...
			<view class="list-1">
				<view>隐患点名称： </view>
				<input type="text" value="" v-model="form.hiddenTroubleName" class="dcinput" />
			</view>
			<view class="list-1">
				<view>整改期限： </view>
				<view class="uni-list-cell-db">
					<picker mode="date" :value="form.rectificationTimeEnd" :start="startDate" :end="endDate" @change="bindDateChange">
			...
			<view class="list-1">
				<view>负责人： </view>
				<input type="text" value="" v-model="form.responsiblePerson" class="dcinput" />
			</view>
			<view class="list-1">
				<view>问题描述</view>
		...
		data() {
			...
			return {
				...
				form: {
					id: "",
					roadId: "",
					hiddenTroubleName:"", // 隐患点名称
					riskId: '', //风险点
					rectificationTimeEnd: new Date().toISOString().slice(0, 10), //日期, //巡查时间
		...
		onLoad(params) {
			...
			if (JSON.stringify(params) !== '{}') {
				...
				this.$http.httpRequest(opts, data).then(res => {
					...
					this.form.attachmentFileList.forEach(item => {
