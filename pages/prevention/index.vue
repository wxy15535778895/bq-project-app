<template>
	<view class="body" style="height: 105%;">
		<view class="typebox">
			<p class="choice" @tap="change(0)" :class="{btna:btnnum == 0}">安全检查</p>
			<p class="choice" @tap="change(1)" :class="{btna:btnnum == 1}">风险管控</p>
			<p class="choice" @tap="change(2)" :class="{btna:btnnum == 2}">隐患查治</p>
			<p class="choice" @tap="change(3)" :class="{btna:btnnum == 3}">安全备案</p>
		</view>
...
<script>
	import Luji from './check/index'
	import Lumian from './Risk/index'
	import Yanxian from './hidden/index'
	import gouzaowu from './record/index'
