	...
	<view class="content sign2">
		<view class="page-body">
			<view class="page-section page-section-gap">
				<map class="map" @callouttap @controltap="controltap" :scale="scale" :controls="controls" :latitude="latitude"
				 :longitude="longitude" :circles="circles" :markers="covers" />
			</view>
			<view class="text-info">
				...
				<view class="inputV">
					<button style="color: white;" :class="isTrue === true ? 'bgBlue' : isTrue === false ? 'bgGreen' : isTrue === null ? 'bgAsh' : ''"
					 @click="clickSign">
						{{time}} --- {{signText}}
					</button>
				</view>
